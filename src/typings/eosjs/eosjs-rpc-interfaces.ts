// https://github.com/EOSIO/eosjs/blob/master/src/eosjs-rpc-interfaces.ts
...
export interface Abi {
  ...
  error_messages: Array<{ error_code: number; error_msg: string }>
  abi_extensions: Array<{ tag: number; value: string }>
  variants?: Array<{ name: string; types: string[] }>
  action_results?: Array<{ name: string; result_type: string }>
  kv_tables?: Array<{
    [key: string]: {
      type: string
      primary_index: { name: string; type: string }
      secondary_indices: Array<{ [key: string]: { type: string } }>
    }
  }>
}
...
export interface BlockHeader {
  ...
  header_extensions: Array<[number, string]>
}
...
// This is modified into a generic interface to allow custom passing of typings.
